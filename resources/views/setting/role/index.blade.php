    ...
    <div class="ogroz-data-table">
        <div class="d-flex flex-wrap align-items-center py-2">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                @can('create role')
                    <a class="btn btn-primary m-1" href="{{ route('roles.create') }}">
        ...
        <div class="p-3 rounded bg-body border mt-2 table-responsive">
            <table class="table table-hover rounded-2  overflow-hidden display" id='roles-table'>
            </table>
        </div>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            const columnDefinitions = [{
                ...
                @canany(['edit role', 'delete role', 'view role'])
                    {
                        name: 'Action',
                        data: null,
                        orderable: false,
                        render: function(data, type, row, meta) {
                            ...
                            @can('view role')
                                html += `<li>
                                            <a href="{{ route('roles.show', ':id') }}" class="dropdown-item action-btn">
                            ...
                            @can('edit role')
                                html += `<li>
                                            <a href="{{ route('roles.edit', ':id') }}" class="dropdown-item action-btn">
                            ...
                            @can('delete role')
                                html += `<li>
                                            <a data-action-url="{{ route('roles.destroy', ':id') }}" class="btn dropdown-item action-btn delete-item">
            ...
            $('#roles-table').empty().append(thead);
            ...
            $('.bulk-delete-rows').on('click', function(e) {
                ...
                e.preventDefault();
                const element = $(this);
                const url = "{{ route('roles.destroy', ':id') }}".replace(':id', selectedIds);
